...
🔹 Download the [mod](https://www.nexusmods.com/palworld/mods/3300?tab=files) and extract it directly to the Palworld directory that you just opened. Make sure to download the version of the mod for your platform.
                    ...
                    └── 📁 PalSchema
                        └── 📁 Mods
                            └── 📁 LegendaryGlider
                                ...
                                │   └── 📄 ultra_glider.jsonc
                                ├── 📁 raw
                                │   ├── 📄 ultra_glider_icon.jsonc
                                │   ├── 📄 ultra_glider_icon_dt.jsonc
                                │   ├── 📄 ultra_glider_recipe.jsonc
                                │   └── 📄 ultra_glider_techtree.jsonc
                                ├── 📁 resources
                                │   ├── 📁 images
                                |   │   └── 📄 T_itemicon_Glider_Glider_Ultra.png
                                └── 📁 translations
                                    ├── 📁 en
                                    │   └── 📄 glider_translations.json
                                    └── 📁 es
                                        └── 📄 glider_translations.json
```
